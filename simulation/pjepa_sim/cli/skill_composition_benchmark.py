"""Run the P-JEPA skill-composition benchmark."""
...
def main() -> None:
    ...
    path = OUT / "skill_composition_benchmark.json"
    table_path = OUT / "skill_composition_benchmark.md"
...
def print_table(results: dict) -> None:
    print("Skill-composition benchmark")
    for name, metrics in results["learners"].items():
        print(
            f"  {name:>28s}  "
