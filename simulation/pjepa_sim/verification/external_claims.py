"""Verify the Meta-World hidden-regime benchmark claims."""
...
OUT = OUTPUT_DIR
RESULTS = OUT / "metaworld_strategy_benchmark.json"
VERIFY = OUT / "metaworld_strategy_verification.json"


def main() -> int:
    agents = strategy_aggregates(load_json(RESULTS), nested=False)
    checks = {
        "obstruction_probe_reduces_unsafe_vs_no_probe": (
            agents["fixed_no_probe"]["unsafe_rate"]
            - agents["obstruction_probe_belief_safe"]["unsafe_rate"]
        ),
        "obstruction_probe_beats_no_probe_score": (
            agents["obstruction_probe_belief_safe"]["risk_adjusted_score"]
            - agents["fixed_no_probe"]["risk_adjusted_score"]
        ),
        "obstruction_probe_beats_same_budget_random_unsafe": (
            agents["random_one_probe_belief_safe"]["unsafe_rate"]
            - agents["obstruction_probe_belief_safe"]["unsafe_rate"]
        ),
        "obstruction_probe_beats_same_budget_random_score": (
            agents["obstruction_probe_belief_safe"]["risk_adjusted_score"]
            - agents["random_one_probe_belief_safe"]["risk_adjusted_score"]
        ),
        "obstruction_probe_beats_entropy_unsafe": (
            agents["entropy_probe_belief_safe"]["unsafe_rate"]
            - agents["obstruction_probe_belief_safe"]["unsafe_rate"]
        ),
        "obstruction_probe_beats_entropy_score": (
            agents["obstruction_probe_belief_safe"]["risk_adjusted_score"]
            - agents["entropy_probe_belief_safe"]["risk_adjusted_score"]
        ),
        "obstruction_probe_uses_fewer_probes_than_exhaustive_random": (
            agents["random_probe_belief_safe"]["mean_probes"]
            - agents["obstruction_probe_belief_safe"]["mean_probes"]
        ),
        "obstruction_probe_matches_exhaustive_random_score_within_tolerance": (
            0.001
            - abs(
                agents["obstruction_probe_belief_safe"]["risk_adjusted_score"]
