...
- Action-grounding challenge: the practical-use harness jointly verifies passive-representation failure, predicted-test learning, safe probe repair, restriction-map gluing, and skill composition under the controlled local assumptions.
